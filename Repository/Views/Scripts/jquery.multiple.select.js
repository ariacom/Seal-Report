/**^zhixin wen <wenzhixin2010@gmail.com> version 1.0.4 http://wenzhixin.net.cn/p/multiple-select/ */
(function($) {
				'use strict';
	...
	MultipleSelect.prototype = {
		...
		open: function() {
			...
			this.$drop.show();
			if (this.options.filter) {
			/*Seal modification -> crash on isopen
		...
		close: function() {
	/*	Seal modification -> do not close

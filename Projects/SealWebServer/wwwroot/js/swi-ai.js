...
(function ($) {
    ...
    function formatResponse(text) {
        ...
        function inline(s) {
            ...
            s = s.replace(SuggestionRegex, function (_m, label, message) {
        ...
        function renderTable(header, aligns, body) {
            const cell = function (tag, value, col) {
    ...
    $messages.on('click', '.ai-table-btn', function (e) {
        e.stopPropagation();
        const $btn = $(this);
    ...
    $messages.on('click', 'a.ai-suggest', function (e) {
        e.preventDefault();
        e.stopPropagation();
        if (_requesting)
            return;
